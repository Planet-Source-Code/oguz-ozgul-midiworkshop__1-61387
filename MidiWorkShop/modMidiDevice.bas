...
Public Function PrepareShortMessage(ByRef typEvent As MidiEvent) As Long
    Dim lngResult As Long
    With typEvent
        Select Case .MidiEventType
            Case MIDI_MIDI_EVENT_TYPE_NOTE_OFF, MIDI_MIDI_EVENT_TYPE_NOTE_ON, MIDI_MIDI_EVENT_TYPE_POLYPHONIC_KEY_PRESSURE, MIDI_MIDI_EVENT_TYPE_CONTROL_CHANGE, MIDI_MIDI_EVENT_TYPE_PITCH_WHEEL_CHANGE
